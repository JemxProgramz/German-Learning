...
export function SprechenView() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in max-w-3xl mx-auto mt-4 md:mt-8">
      ...
      <Card className="p-8 md:p-12 text-center shadow-sm border-neutral-200/60 dark:border-neutral-800/80 relative overflow-hidden">
        {recording && (
        ...
        <h2 className="text-3xl font-bold text-neutral-900 dark:text-neutral-100 mb-2 leading-tight">
          Stellen Sie sich vor.
        </h2>
        <p className="text-neutral-500 dark:text-neutral-400 mb-10 text-lg">(Introduce yourself)</p>
        
        <div className="text-sm text-neutral-700 dark:text-neutral-300 mb-12 max-w-sm mx-auto text-left bg-neutral-50/50 dark:bg-neutral-800/50 p-6 rounded-xl border border-neutral-100 dark:border-neutral-700/50">
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative">
              ...
              <button
                ...
                className={`relative z-10 w-24 h-24 rounded-full flex items-center justify-center text-white dark:text-neutral-900 transition-all shadow-lg ${
                  recording 
              ...
              >
                {recording ? <Square size={36} className="fill-current" /> : <Mic size={36} />}
              </button>
            </div>
            <span className={`font-semibold text-lg ${recording ? 'text-red-500 dark:text-red-400 animate-pulse' : 'text-neutral-700 dark:text-neutral-300'}`}>
              {recording ? 'Recording in progress... Click to stop.' : 'Click the microphone to start speaking'}
            </span>
          </div>
        ) : (
          <div className="space-y-8 animate-in zoom-in-95 pt-4 border-t border-neutral-100 dark:border-neutral-800">
            <div className="flex justify-center mb-4">
              <div className="w-20 h-20 bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-900/30 rounded-full flex items-center justify-center text-green-600 dark:text-green-500">
                <Check size={40} className="mt-1" />
              </div>
            </div>
            <div>
              <h3 className="font-bold text-2xl mb-2 text-neutral-900 dark:text-neutral-100">Sehr gut!</h3>
              <p className="text-neutral-500 dark:text-neutral-400 text-lg">Speaking practice successfully recorded.</p>
            </div>
            
            <div className="flex justify-center gap-4 pt-4">
               <Button onClick={() => setFinished(false)} size="lg" variant="outline" className="gap-2 px-8 shadow-sm">
